...
namespace ama {
	...
	bool Date::operator==(const Date& rhs)  const {
		bool v = d_year == rhs.d_year && d_month == rhs.d_month && d_day == rhs.d_day;
		return v;
	}
	...
	bool Date::operator<(const Date& rhs) const {
		bool v = (d_year < rhs.d_year) || (d_month < rhs.d_month && d_year == rhs.d_year) || (d_day < rhs.d_day && d_month == rhs.d_month && d_year == rhs.d_year);
		return v;
	}
