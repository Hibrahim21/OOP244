...
namespace sict {
	...
	const Hero& operator*(const Hero& first, const Hero& second) {
		...
		if ((leftHero.isAlive() != true) && (rightHero.isAlive() != true)) {
			victor = leftHero;
			cout << "Ancient Battle! " << leftHero << " vs " << rightHero << " : Winner is " << leftHero << " in " << roundNum << " rounds." << endl;
			return first;
		}
		else if (leftHero.isAlive() != true) {
			victor = rightHero;
			cout << "Ancient Battle! " << leftHero << " vs " << rightHero << " : Winner is " << rightHero << " in " << roundNum << " rounds." << endl;
			return second;
		}
